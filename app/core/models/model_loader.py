...
class ModelLoader:
    ...
    def load_yolo_object_model(self, weights_path: Optional[str] = None) -> Any:
        ...
        if weights_path is None:
            weights_path = getattr(self.settings, 'yolo_weights', 'yolo11l.pt') if self.settings else 'yolo11l.pt'
    ...
    def load_yolo_pose_model(
        ...
        if weights_path is None:
            weights_path = getattr(self.settings, 'yolo_pose_weights', 'yolo11l-pose.pt') if self.settings else 'yolo11l-pose.pt'
