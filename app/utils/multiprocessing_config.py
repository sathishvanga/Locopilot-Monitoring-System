...
class MultiprocessingConfig:
    ...
    # Model preloading settings - YOLO11m for object detection (medium model, balanced speed/accuracy)
    ...
    yolo_model_path: str = os.getenv("YOLO_WEIGHTS_PRELOAD", "yolo11m.pt")  # YOLO11m model for object detection
