...
def worker_initializer(config: MultiprocessingConfig):
    ...
    try:
        ...
        if config.preload_models:
            ...
            # NOTE: VotingVerificationService is intentionally NOT preloaded
            # here; it depends on the VideoReader changes planned in task
            # 0004.  TODO(task-0004): move it into worker_initializer once
            # the voting service's video-access contract is stable.
            # ------------------------------------------------------------------
            try:
