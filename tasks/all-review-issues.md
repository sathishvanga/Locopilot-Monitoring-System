...
- **Description:** When `YOLO_DEVICE=0` (GPU), every worker process loads both YOLO26 and YOLO26-pose onto the same GPU. With `max_workers_cap=10`, this means up to 10 copies (500MB-1GB each). On RTX 4000 Ada (20GB), workers will OOM.
